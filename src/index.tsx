...
import { AcmeWidgetProps, AcmeWidget } from "./acme-widget";
 ...
 */
const widgetAttributes: string[] = ["quote"];
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <acme-widget message="world!"></acme-widget>
   */
  return class AcmeWidgetBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): AcmeWidgetProps {
      const attrs = this.parseAttributes<AcmeWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<AcmeWidget {...this.props} />, container);
    }
